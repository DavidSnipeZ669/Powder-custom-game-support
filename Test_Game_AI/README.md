# Test Game AI - AI-Optimized Powder Game Support
...
**Created:** 2026-05-30
**AI Analysis:** 2026-05-30 17:21:20
...
- **kill**: 2 patterns detected, 89.0% confidence
- **headshot**: 1 patterns detected, 92.0% confidence
- **double_kill**: 1 patterns detected, 87.0% confidence
- **victory**: 1 patterns detected, 95.0% confidence
...
```bash
cp -r Test Game AI /path/to/powder/games/
```

2. **Select in Powder:**
- Launch Powder
- Go to Game Selection
- Choose Test Game AI (AI-Optimized)
- Start recording
