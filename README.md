...
Now launch Powder and you'll be in the Developer Console, to deactivate permanently, rename app.asar to app2.asar.bak and app.asar.bak to app.asar, to close it for just that session, just click the cross at the top right of the console.
