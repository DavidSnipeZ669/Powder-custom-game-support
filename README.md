...
Now launch Powder and you'll be in the Developer Console, to deactivate permanently, rename the current app.asar to something else (or delete it) and rename the backup app.asar.bak to app.asar, to close it for just that session, just click the cross at the top right of the console.
